 ...
 * @augments EpubItem
 */
var EpubImage = /*#__PURE__*/function (_EpubItem) {
  _inherits(EpubImage, _EpubItem);

  var _super = _createSuper(EpubImage);

  function EpubImage() {
    _classCallCheck(this, EpubImage);

    return _super.apply(this, arguments);
  }

  _createClass(EpubImage, null, [{
    key: "getType",
    ...
    value: function getType() {
      return _ItemTypeEnum["default"].IMAGE;
    }
  }]);
...
EpubImage.prototype.toString = function () {
  return "<EpubImage:".concat(_this.id, ":").concat(_this.fileName, ">");
};

var _default = EpubImage;
